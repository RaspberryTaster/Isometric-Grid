...
{
	public class StateMachine : MonoBehaviour, IQueue, IDequeue
	{
		public IQueue current_Strategy;
		List<IAction> actions = new List<IAction>();
		[SerializeField] List<ActionTypesDebug> actionNames = new List<ActionTypesDebug>();
		...
		public void Insert_To_Action_Queue(IAction action, ActionTypesDebug action_Types, int acitonIndex)
		{
		...
		public void Dequeue_All_Before_Adding_Action(IAction action, ActionTypesDebug action_Types)
		{
			Dequeue_All();

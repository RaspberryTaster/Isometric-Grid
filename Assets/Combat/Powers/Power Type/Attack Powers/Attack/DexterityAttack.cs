...
{
	public class DexterityAttack : IAttack
	{
		public int Modifier { get; set; }
		private ITargetDefence targetDefence;
		public ITargetDefence TargetDefence => targetDefence;

		public DexterityAttack(ITargetDefence targetDefence, int modifier = 0)
		{
		...
		{
			int modifiers = instigator.DexterityMod + (int)math.floor(instigator.Level / 2) + instigator.equippedWeapon.ProficencyBonus + instigator.equippedWeapon.EnhancementBonus + Modifier;

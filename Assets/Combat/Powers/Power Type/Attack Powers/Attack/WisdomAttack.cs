...
{
	public class WisdomAttack : IAttack
	{
		public int Modifier { get; set; }
		private ITargetDefence targetDefence;
		public ITargetDefence TargetDefence => targetDefence;

		public WisdomAttack(ITargetDefence targetDefence, int modifier = 0)
		{
		...
		{
			int modifiers = instigator.WisdomMod + (int)math.floor(instigator.Level / 2) + instigator.equippedWeapon.ProficencyBonus + instigator.equippedWeapon.EnhancementBonus + Modifier;
